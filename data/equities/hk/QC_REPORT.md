...
由 `scripts/check_data_quality.py` 產生。主來源 yfinance（`data/equities/hk/`）113 檔，第二來源港交所官方快照（`data/stocks_hkex/`）46 份（最新 2026-09-25），公司名紀錄 112 檔。
...
| 0011.HK | constituent_no_data | 恒生銀行 2026-01 私有化下市，Yahoo 已無價格——倖存者偏差殘留（已知、回測報告揭露） |
| 0494.HK | constituent_no_data | 利豐 2020 私有化下市，Yahoo 無價格——倖存者偏差殘留 |
| 0001.HK | hkex_vs_wiki_name | 港交所簡稱 CKH HOLDINGS = 長和 CK Hutchison |
| 0013.HK | hkex_vs_wiki_name | 已知代碼重用：2015 年前 0013 是和記黃埔，現為和黃醫藥 HUTCHMED；回測由防代碼重用檢查擋掉 |
| 0016.HK | hkex_vs_wiki_name | 港交所簡稱 SHK PPT = 新鴻基地產 |
| 0316.HK | hkex_vs_wiki_name | 港交所簡稱 OOIL = 東方海外國際 |
| 0939.HK | hkex_vs_wiki_name | 港交所簡稱 CCB = 建設銀行 |
| 0981.HK | hkex_vs_wiki_name | 港交所簡稱 SMIC = 中芯國際 |
| 1038.HK | hkex_vs_wiki_name | 港交所簡稱 CKI HOLDINGS = 長江基建 |
...
| 0330.HK | ohlc_auction | 思捷環球：開/收市價落在高低價外是港股收市競價慣例，不是髒值 |
...
| 0960.HK | wiki_name_varies | Wikipedia 2023 年誤記：0960 是龍湖集團，領展是 0823 |
...
| 6098.HK | wiki_name_varies | 同上，Wikipedia 2025 年把 6098 誤記為 Country Garden |
...
| 0330.HK |  | 1（2010-01-15） | 11（2026-08-24） | 4（2025-08-22） |
