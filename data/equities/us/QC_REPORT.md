...
市場最新交易日 2026-09-23；現任成分股 518 檔（sp500, ndx, djia）；有數據 722 檔；第二來源快照 2 份、比對 763 筆收市價。
...
- `EA` stale：現任成分股最後一根 2026-08-04，市場最新 2026-09-23（Electronic Arts 2026-08 私有化下市；Nasdaq-100 名單是 Wikipedia 年度快照（2026-06-29），尚未反映出榜——回測到 8 月初之後自然沒有它的價格）
...
- 已比對 719/719 檔、1,234,989 筆收市價、不符（>1%）650 筆；第二來源沒有的已下市/改代碼 24 檔（ABI, AVB, BBBY, BF-B, CAM, CPWR, CSRA, EA, EMC, EQR, EWJ, FB, FMCC, FNMA, GENZ, INFO, JAVA, LEG, NFX, PCL…）
