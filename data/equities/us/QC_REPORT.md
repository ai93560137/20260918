...
市場最新交易日 2026-09-21；現任成分股 518 檔（sp500, ndx, djia）；有數據 721 檔；第二來源快照 1 份、比對 2 筆收市價。
...
- 已比對 718/718 檔、1,234,963 筆收市價、不符（>1%）650 筆；第二來源沒有的已下市/改代碼 23 檔（ABI, AVB, BBBY, BF-B, CAM, CPWR, CSRA, EA, EMC, EQR, FB, FMCC, FNMA, GENZ, INFO, JAVA, LEG, NFX, PCL, SBNY…）
