...
| 不測 | 其餘 24 個外匯商品（七大其餘 5 個、12 個交叉盤、澳紐加、港元／離岸人民幣／新加坡元、白銀） | 入場券不及格：日均波幅 ÷ 點差 < 80 倍（零佣金帳戶上限點差：GBPJPY 1.48、EURJPY 1.21、AUDJPY 0.92、GBPUSD 0.88 pip；其餘 ≤ 0.9 pip 且波幅更小）。券商實際點差在上限內者可另行登記 |
