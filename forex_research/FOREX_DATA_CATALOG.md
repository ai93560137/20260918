...
### 2026-09-24 快照（首次全抓完成；細節見 DATA_QC.md）

Dukascopy D1 全部從 2000-01-03 起、H1 從 2003 起、近期 M1 到 2026-09-23；HistData M1 起點與入場券（手冊鐵律 2：日均波幅 ÷ 來回成本 > 80 倍，
這裡的成本只算 Dukascopy ECN 點差，**CFD 券商點差通常寬 2–5 倍，實際入場券要按自己券商重算**）：

| 商品 | M1 起（HistData） | M1 根數 | Dukascopy 點差中位（近 3 年，pips） | 日均波幅÷點差 | HistData vs Dukascopy 小時收市差中位 | 入場券（> 80 倍） |
|---|---|---:|---:|---:|---:|---|
| EURUSD | 2000-05-30 | 8,989,932 | 0.3 | 182.0 | 0.0024% | ✅ |
| USDJPY | 2000-05-30 | 8,952,441 | 0.6 | 159.7 | 0.0029% | ✅ |
| EURJPY | 2002-03-04 | 8,835,778 | 1.0 | 96.4 | 0.0031% | ✅ |
| AUDJPY | 2002-08-19 | 8,323,624 | 0.8 | 92.3 | 0.0046% | ✅ |
| GBPUSD | 2000-05-30 | 8,874,599 | 0.8 | 87.9 | 0.0031% | ✅ |
| XAUUSD | 2009-03-15 | 6,137,694 | 52.0 | 75.5 | 0.0019% | ❌ |
| NZDJPY | 2006-09-03 | 7,294,343 | 1.0 | 66.0 | 0.006% | ❌ |
| GBPJPY | 2002-05-01 | 8,824,569 | 1.9 | 62.4 | 0.0043% | ❌ |
| CADJPY | 2007-03-18 | 7,150,429 | 1.2 | 57.8 | 0.0024% | ❌ |
| USDCHF | 2000-05-30 | 8,967,421 | 0.9 | 52.4 | 0.0047% | ❌ |
| CHFJPY | 2002-08-19 | 8,680,322 | 2.2 | 46.8 | 0.0035% | ❌ |
| AUDUSD | 2000-06-05 | 8,349,207 | 1.0 | 46.2 | 0.0039% | ❌ |
| USDCAD | 2000-06-12 | 8,061,801 | 1.2 | 44.8 | 0.0041% | ❌ |
| USDCNH | 2026-07-24 | 62,872 | 3.7 | 43.1 | —（HistData 無）% | ❌ |
| NZDUSD | 2005-08-12 | 7,247,301 | 1.1 | 39.5 | 0.0038% | ❌ |
| EURAUD | 2002-08-19 | 8,739,589 | 2.4 | 36.4 | 0.0032% | ❌ |
| EURCHF | 2002-01-14 | 8,193,632 | 1.0 | 35.2 | 0.0018% | ❌ |
| EURGBP | 2002-03-04 | 8,269,549 | 0.8 | 34.6 | 0.0038% | ❌ |
| EURCAD | 2007-03-18 | 7,157,901 | 1.9 | 34.1 | 0.0027% | ❌ |
| USDSGD | 2008-08-31 | 5,851,836 | 1.4 | 31.4 | 0.0022% | ❌ |
| GBPCHF | 2002-08-19 | 8,721,851 | 1.8 | 29.6 | 0.0052% | ❌ |
| XAGUSD | 2009-05-03 | 5,857,355 | 3.0 | 28.3 | 0.0116% | ❌ |
| GBPAUD | 2007-09-30 | 6,962,089 | 3.7 | 27.3 | 0.0023% | ❌ |
| AUDCAD | 2007-09-30 | 6,928,512 | 1.9 | 25.1 | 0.0043% | ❌ |
| AUDNZD | 2007-09-30 | 6,942,846 | 2.0 | 21.0 | 0.0038% | ❌ |
| USDHKD | 2008-08-31 | 4,018,975 | 2.6 | 15.3 | 0.0004% | ❌ |

- 26 個商品 Release 共約 1.9 GB（每商品 60–90 MB；USDCNH 只有 Dukascopy D1／H1 與近 62 天 M1）
- 25 個有 HistData 的商品，HistData M1 聚合小時收市 vs Dukascopy H1 的絕對差中位全部 ≤ 0.012%、時差核對最佳位移全部為 0
- XAUUSD 另對券商 MT5 H1（data/，2022-08 起）：收市差中位 0.005%、最差月 0.013%；券商時差逐月是 UTC+2（冬）／UTC+3（夏）
- FRED 紐約中午匯率 vs Dukascopy H1 16／17 時收市：差中位 0.01–0.04%；Yahoo 日線因日界不同差 0.1–0.3% 屬正常
