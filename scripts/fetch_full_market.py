#!/usr/bin/env python3
"""全市場日線（stock_research/VCP_FULLMARKET_BACKTEST.md）→ data_full/<market>/<TICKER>.csv.gz（不進 git，存 Actions 快取）。
...
CLOSE = {"hk": ("Asia/Hong_Kong", 16, 40), "jp": ("Asia/Tokyo", 16, 0), "us": ("America/New_York", 16, 30),
         # 樣本外驗證新市場（stock_research/OOS_VALIDATION.md）：台灣 13:30、韓國 15:30、澳洲 16:10（收市競價）收市
